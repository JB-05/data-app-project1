    ...
    <div className="text-white">
        <div className="max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center">
            ...
            <div className="flex justify-center items-center">
                ...
                <ReactTyped 
                className="md:text-5xl sm:text-4xl text-xl font-bold md:pl-4 pl-2 text-[#393939]"
            ...
            <button className="bg-[#00df9a] w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3 text-[#000300]">Get Started</button>
